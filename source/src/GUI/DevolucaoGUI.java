...
/**
 * Subclasse de JDialog - interface grafica de devolucao do livro (emprestado da biblioteca)
 */
public class DevolucaoGUI extends JDialog implements ActionListener {
    ...
    private void initComponents() {
        ...
        lblRetire.setText("Escolha uma devolução");
